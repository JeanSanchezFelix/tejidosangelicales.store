      ...
      var x =
            ...
            e &&
              ...
              (0, r.default)(function () {
                e.forEach(function (e) {
                  e.target &&
                    e.target.jarallax &&
                    (f || e.target.jarallax.onResize(), (y = !0));
                });
              });
          }),
        w = 0,
                  ...
                  if (
                    ...
                    if (
                      ...
                      ("opacity" !== t.options.type &&
                        ...
                        "scroll-opacity" !== t.options.type) ||
                        ((a.transform = "translate3d(0,0,0)"), (a.opacity = g)),
                      ...
                      t.options.speed < 0
                        ? (b -= t.options.speed * g)
                        : (b += t.options.speed * (1 - g)),
                        (a.transform = "scale(" + b + ") translate3d(0,0,0)");
                    }
                    if (
                      "scroll" === t.options.type ||
                      "scroll-opacity" === t.options.type
        ...
        j = function (e) {
          ...
          for (
            ...
            if (
              ("object" === (void 0 === t ? "undefined" : i(t)) || void 0 === t
                ? e[a].jarallax || (e[a].jarallax = new $(e[a], t))
                : e[a].jarallax &&
                  (r = e[a].jarallax[t].apply(e[a].jarallax, o)),
              void 0 !== r)
            )
              return r;
          return e;
